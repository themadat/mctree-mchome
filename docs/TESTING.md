...
- [ ] Every person search result shows compact Preferred, Current, and Lineal name rows; starring one persists across reloads, pins it above unstarred matches, and exposes an obvious gold accessible pressed state without activating the person.
