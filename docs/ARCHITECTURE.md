...
Settings exposes Data Cleanup as its own sidebar section to Owner and Editor roles without requiring Developer Mode. The read-only diagnostics classify suspicious-but-loadable relationships, mismatched current postal addresses for living ongoing partners, unknown or partial life dates, unknown names, and invalid Lineage IDs. Every category is independently collapsible and links back to the affected editor; Member and Viewer roles cannot access the section.
