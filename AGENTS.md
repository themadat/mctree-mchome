...
When the user sends only `continue`, inspect Git status, recent changes, and any existing handoff or active plan, then resume the unfinished work without creating a separate status file or tracking system.
