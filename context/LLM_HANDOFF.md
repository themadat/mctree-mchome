...
- Editors can add/edit people, places, contacts, and relationships. Parent-child links use Biological, Adopted, Step, Foster, Guardian, or Unknown status. New edits allow Biological and Adopted to be Lineal and enforce all other statuses as Non-Lineal; legacy violations remain loadable until Admin corrects them from the Developer cleanup lists. Sibling lists include Self, place unknown birth years last, and label step siblings separately. Lineage id is normally auto-generated from parents; legacy malformed or inconsistent values remain loadable and are listed for Admin cleanup. Preferred follows changed legal name; maiden last initially follows birth last. Each saved field-level change produces an audit line.
