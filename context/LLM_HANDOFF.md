...
- First launch accepts only the exact 30-column McLineage v14 CSV or a current native `mcfamily-csv-v2` CSV containing at least one person. There is no demo family, blank-family path, JSON/GEDCOM import, or bypass.
