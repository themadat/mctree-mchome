...
- `assets/js/core/state.js`: schema v9, structured-name migration/normalization, fuzzy matching, and validation.
...
- First launch accepts only the cleaned McLineage CSV or a native `mcfamily-csv-v2` CSV containing at least one person. There is no demo family, blank-family path, JSON/GEDCOM import, or bypass.
