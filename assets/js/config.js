(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.130",
        date: "2026-09-06T18:50:05.000Z",
        title: "Fuller portrait reports",
        summary: "Directory, Outline, and Groups now fill accurate portrait previews, and descendant branches retain their parents' left-to-right order.",
        features: [],
        improvements: ["Made Directory, Outline, and Groups previews use their compact native print typography and fuller Letter portrait sheets", "Increased Outline and Directory page density while keeping report content inside each page"],
        fixes: ["Kept a narrow descendant branch ahead of wider branches belonging to parents on its right", "Changed Outline from landscape to portrait in preview and native print"],
        knownIssues: []
      }
    ],
