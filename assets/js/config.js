(function () {
  ...
  const CONFIG = {
    ...
    controls: {
      ...
      maxPrintOutlineRows: 20,
      maxPrintDirectoryUnits: 28,
      maxPrintGroupUnits: 24,
    ...
    releases: [
      {
        version: "0.0.1.129",
        date: "2026-09-06T18:23:05.000Z",
        title: "Paged print previews",
        summary: "Outline, Groups, and Directory now show explicit page sheets, while Lineage Tree printing fits larger branches into fewer pages.",
        features: [],
        improvements: ["Added visible Letter page boundaries and page counts to Outline, Groups, and Directory previews", "Raised focused Lineage print capacity to twelve levels and sixteen people across without changing Full Tree limits"],
        fixes: ["Kept Tree page planning stable when the print scale changes", "Sized Directory sheets conservatively so household cards remain inside each page"],
        knownIssues: []
      }
    ],
