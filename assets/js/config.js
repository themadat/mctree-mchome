(function () {
  ...
  const CONFIG = {
    ...
    controls: {
      ...
      maxPrintTreeLevels: 6,
      maxPrintTreePeopleAcross: 8,
    ...
    releases: [
      {
        ...
        title: "Smarter Family Tree pagination",
        summary: "Family Tree printing now divides large trees by generation levels and people per row instead of slicing the SVG into arbitrary pixel tiles.",
        features: ["Added a six-level and eight-person maximum to each printed Tree page", "Repeated the boundary generation between vertical page sections so lineage context carries forward"],
        improvements: ["Keeps partner groups together and repeats available parent context during horizontal pagination", "Labels every Tree page by level range and horizontal section"],
        fixes: ["Prevents person cards from being clipped by raw print tile boundaries"],
        knownIssues: []
      }
    ],
