(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.133",
        date: "2026-09-07T19:17:18.000Z",
        title: "Outline lineage controls and print state",
        summary: "Outline now keeps authoritative generation numbers, centers selected people, and prints only the branches currently expanded.",
        features: ["Added Condense Lineage with the requested symbol to collapse branches outside the selected person's direct lineage"],
        improvements: ["Stacked fully known birth and death dates without making rows taller", "Put All on the second line of the Expand and Condense controls"],
        fixes: ["Kept generation labels stable when changing the Outline root", "Removed the print chevron gutter and tightened Generation-to-person spacing", "Centered visible selected people after Outline search and selection"],
        knownIssues: []
      }
    ],
