(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.132",
        date: "2026-09-07T18:50:54.000Z",
        title: "Related-person address autofill",
        summary: "New people created from a relationship can now start with the related person's current address already filled in.",
        features: ["Added a default-on related-person address autofill when creating a new person from a relationship"],
        improvements: ["Placed the autofill checkbox immediately above Addresses with clear source-person status"],
        fixes: ["Detached a copied address from the related person's shared place as soon as the new address is edited"],
        knownIssues: []
      }
    ],
