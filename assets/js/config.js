    ...
    releases: [
      {
        ...
        title: "Focused family print views",
        summary: "Directory, Groups, and the live Family Tree now have separate print actions, with a slightly narrower centered search field.",
        features: ["Added a Groups report for generation maps and a paginated Tree report that follows the active tree mode, card, name, level, line, and zoom settings"],
        improvements: ["Kept Directory focused on household contact cards and placed Tree at the far right of the Family Tree controls"],
        fixes: ["Prevented generation maps from being appended to the Directory and preserved unknown-partner path references in Developer print previews"],
        knownIssues: []
      }
    ],
