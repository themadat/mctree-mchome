(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.122",
        date: "2026-09-04T16:58:02.000Z",
        title: "Aligned Outline roots and spouses",
        summary: "Outline now keeps its Root selector compact, shows the selected root's people count, and gives spouse cards the same consistent width as Lineal cards.",
        features: ["Added a people-count pill to the selected Outline root"],
        improvements: ["Aligned the compact Root control with View and Name Preferences", "Matched spouse card widths to Lineal person cards on screen and in print"],
        fixes: [],
        knownIssues: []
      }
    ],
