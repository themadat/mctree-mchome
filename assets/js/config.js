(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.135",
        date: "2026-09-07T20:14:11.000Z",
        title: "Expanded Outline lineage and denser print pages",
        summary: "Condense Lineage now preserves the selected person's full descendant branch while the Outline uses its portrait pages more fully.",
        features: [],
        improvements: ["Expanded every descendant below the selected person after Condense Lineage", "Fit up to 44 compact Outline rows on each portrait page", "Added readable separation between stacked birth and death dates without making rows taller"],
        fixes: ["Stopped Condense Lineage from hiding the selected person's descendants"],
        knownIssues: []
      }
    ],
