(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.121",
        date: "2026-09-04T16:32:22.000Z",
        title: "Refined Outline roots and relationships",
        summary: "Outline now has a lineage-only searchable root picker, a Root Ancestor reset, shared Name Preferences, centered relationship details, and neutral spouse cards.",
        features: ["Added searchable Outline root selection limited to the Root Ancestor's Lineal descendants", "Kept Name Preferences available and active in Outline"],
        improvements: ["Changed the root action to Reset Root", "Centered relationship type and date on separate lines within the connection bar", "Removed the Lineal accent from spouse cards on screen and in print"],
        fixes: [],
        knownIssues: []
      }
    ],
