  ...
  const CONFIG = {
    ...
    releases: [
      ...
      },
      {
        ...
        title: "Complete unknown-status links",
        summary: "Question-mark partner links now visibly span the full distance between both person cards.",
        features: [],
        improvements: ["Unknown-status marks scale to each connector's exact rendered length"],
        fixes: ["Removed the blank gap before the destination card on short and long unknown partner links"],
        knownIssues: []
      },
      {
        version: "0.0.1.95",
        date: "2026-08-27T15:19:51.000Z",
        title: "Side-by-side partner history",
        summary: "Two prior partners keep their separate left-side positions while both relationship lines connect cleanly.",
        features: [],
        improvements: ["Two historical partners remain side by side in chronological order", "Upper and lower parallel links avoid crossing either compact name card"],
        fixes: ["The latest stacked layout no longer combines two prior partners into one horizontal slot"],
        knownIssues: []
      },
      {
        version: "0.0.1.94",
