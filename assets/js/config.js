(function () {
  ...
  const CONFIG = {
    ...
    help: [
      { id: "start", title: "Getting started", section: "Basics", keywords: "start import csv backup seed first launch", html: "<p>McFamily opens after you import the exact McLineage v13 CSV or a current native McFamily CSV export. The file is mapped, validated, and previewed before it replaces local data. Earlier source schemas and browser states are not migrated. There is no demo-family or blank-family bypass.</p>" },
