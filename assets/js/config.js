(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.134",
        date: "2026-09-07T19:43:46.000Z",
        title: "Editor data cleanup workspace",
        summary: "Data Cleanup is now a dedicated editor-visible Settings section with focused, collapsible data-quality checks.",
        features: ["Added collapsible checks for relationships, partner addresses, birth and death dates, names, and Lineage IDs"],
        improvements: ["Moved cleanup out of the Admin Settings content and made it available to every editing role", "Linked each issue to the person or relationship that needs review"],
        fixes: [],
        knownIssues: []
      }
    ],
