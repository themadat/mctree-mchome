(function () {
  ...
  const CONFIG = {
    ...
    releases: [
      {
        version: "0.0.1.131",
        date: "2026-09-06T19:14:15.000Z",
        title: "Reliable print sizing and Tree reset",
        summary: "Tree printing now always uses 100% scale, the Tree toolbar can reset to 100%, and portrait reports no longer create alternating blank pages.",
        features: [],
        improvements: ["Added a Reset control between In and Fit that restores the Tree to 100% with the requested symbol", "Packed more Directory households onto each portrait page"],
        fixes: ["Made Tree print scale independent of the interactive Tree zoom", "Removed forced native portrait-page heights that could produce a blank page after each report page"],
        knownIssues: []
      }
    ],
