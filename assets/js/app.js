(function () {
  ...
  function isUnknownPartnerEdge(edge) {
    ...
    return Boolean(relationship && relationship.type === "partner" && ["former", "unknown"].includes(relationship.status));
  }
  ...
  function treeKeyHtml() {
    const rows = [
      ...
      [treeKeySwatch("partner", "partnered"), "Never married"],
