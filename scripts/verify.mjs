...
if (!css.includes('body[data-onboarding="false"] { display: flex; flex-direction: column; height: 100svh; overflow-y: hidden; }') || !css.includes('body[data-onboarding="false"] .family-workspace-grid { flex: 1 1 auto; height: auto; min-height: 0; }')) fail("The initialized application can regain a second vertical scrollbar");
