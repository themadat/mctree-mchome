...
if (config.controls.maxPrintOutlineRows !== 44 || config.controls.maxPrintDirectoryFallbackRows !== 14 || config.controls.maxPrintGroupUnits !== 26 || config.controls.maxPrintGroupPeoplePerSection !== 42) fail("Paged report preview limits are invalid");
