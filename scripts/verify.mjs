...
if (!appSource.includes('mode === "labels" || mode === "outline"') || !appSource.includes('? "@page { size: letter; margin: 0; }"') || !appSource.includes('? "@page { size: letter landscape; margin: .5in; }"') || !appSource.includes(': "@page { size: letter portrait; margin: .5in; }"') || appSource.includes('mode === "tree" || mode === "outline"')) fail("Outline must own its half-inch inset on a zero-margin portrait sheet while Tree remains landscape");
