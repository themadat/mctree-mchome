...
if (!css.includes(".outline-person.outline-spouse { border-left-width: 1px; border-left-color: var(--line);") || !css.includes(".print-outline .outline-person.outline-spouse { border-left-width: .6pt; border-left-color: #aaa;")) fail("Outline spouse cards must not use the Lineal accent in screen or print");
