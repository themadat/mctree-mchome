...
if (!appSource.includes('class="button small outline-action"') || !appSource.includes('(collapsed ? "down" : "up")')) fail("Outline controls must use the shared icon catalog");
if (!css.includes(".outline-row") || !css.includes(".outline-scan-bar") || !css.includes(".outline-action-icon") || !css.includes(".print-outline .outline-row")) fail("Outline screen, controls, or print styling is missing");
