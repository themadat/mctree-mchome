...
if (config.controls.maxPrintOutlineRows !== 44 || config.controls.maxPrintDirectoryUnits !== 70 || config.controls.maxPrintGroupUnits !== 26 || config.controls.maxPrintGroupPeoplePerSection !== 42) fail("Paged report preview limits are invalid");
...
if (!appSource.includes("function paginateOutlineRows") || !appSource.includes("pageRows.length >= config.controls.maxPrintOutlineRows") || !appSource.includes("usedHeight + rowHeight > availableHeight") || !css.includes(".print-outline-measure { position: fixed; top: 0; left: -200vw; width: 8.5in; visibility: hidden; pointer-events: none; }")) fail("Outline print pagination no longer fills pages by measured row height");
